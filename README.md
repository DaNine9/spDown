...
Download the exe, then specify:
  ...
  - then, just input song url and the subfolder where you want them to be stored
      - example: if subfolder is "house", then itll be stored in music/house
